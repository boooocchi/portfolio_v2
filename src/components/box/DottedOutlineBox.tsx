...
const DottedOutlineBox: React.FC<dottedOutlineBoxProps> = ({
  ...
  let dottedOutlineBoxClassName =
    "flex flex-col  md:gap-5 outline-fontGray  md:min-h-[600px]  h-[650px] w-[90%] md:w-[85%] outline-dotted outline-[1px] sm:outline-[2px] lg:mt-[2rem] px-[1.3rem] xs:px-[2rem] md:px-[4rem] py-[2rem] md:py-[3rem] relative px-[1.5rem] py-[1.5rem]";
