          ...
          <div className="flex gap-4 xs:gap-5 items-center  relative">
            ...
            >
              <svg
                ...
                viewBox="0 0 100 100"
                id="linkedin"
                className="h-[1.55rem] sm:h-[1.7rem] md:h-[2rem] fill-mainBlue hover:scale-110 duration-300"
              >
            ...
            >
              <svg
                ...
                viewBox="0 0 16 16"
                id="github"
                className="h-[1.4rem] sm:h-[1.5rem] md:h-[1.8rem] hover:scale-110 duration-300 fill-mainBlue"
              >
