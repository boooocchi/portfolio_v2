      ...
      <DottedOutlineBox lineColor="fontGray">
        <div>
          <div className="flex gap-7 justify-between items-center ">
            ...
            <div className="flex gap-2 xs:gap-5 items-center  relative">
              <p
                className={`w-[150%] absolute left-1/2 -translate-x-1/2 -top-5 text-center ${roboto.className} tracking-tight xs:text-[.6rem] text-[.5rem]`}
              >
                \visit me!!/
              </p>
              <Link
              ...
              >
                <svg
                  ...
                  viewBox="0 0 100 100"
                  id="linkedin"
                  className="h-[1.3rem] sm:h-[1.7rem] md:h-[2rem] fill-white hover:scale-125 duration-300"
                >
              ...
              >
                <svg
                  ...
                  viewBox="0 0 16 16"
                  id="github"
                  className="h-[1.2rem] sm:h-[1.5rem] md:h-[1.8rem] hover:scale-125 duration-300"
                  fill="white"
                >
