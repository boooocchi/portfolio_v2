  ...
  return (
    <Section bgColor="mainYellow" id="contact">
      <DottedOutlineBox lineColor="mainBlack">
        <div className="flex flex-col h-full gap-[5rem]">
          <SectionTitle color="mainBlue">Contact</SectionTitle>
          <form
            className="flex h-full gap-[10%] justify-center"
            onSubmit={handleSubmit(onSubmit)}
            ref={formRef}
          >
            <div className="w-[33%] flex flex-col justify-between pt-3">
              <Input
              ...
              >
                <svg
                  ...
                  fill="none"
                  viewBox="0 0 24 24"
                  className={`w-7 h-7 ${iconColor} duration-300 font-bold`}
                >
                  <path
              ...
              >
                <svg
                  ...
                  className={`w-7 h-7 ${iconColor2} duration-300`}
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  stroke-width="1.5"
                  className={`w-7 h-7  ${iconColor3} duration-300`}
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
            ...
            <div className="w-[55%] flex flex-col justify-center items-center">
              <textarea
                className="h-full w-full bg-fontGray p-8  text-mainBlack mb-2 focus:outline-accentOrange"
