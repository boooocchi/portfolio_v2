  ...
  return (
    <Section bgColor="mainYellow" id="contact">
      <DottedOutlineBox lineColor="mainBlack">
        <div className="flex flex-col h-full md:gap-[5rem]">
          <SectionTitle color="mainBlue">Contact</SectionTitle>
          <div className="w-full h-full relative">
            <form
              className="flex flex-col md:flex-row h-full md:gap-[10%] gap-[5%] md:justify-center"
              onSubmit={handleSubmit(onSubmit)}
              ref={formRef}
            >
              <div className="w-full md:w-[33%] flex flex-col md:justify-between  mt-3 ">
                <Input
                ...
                >
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke={
                      isFocused.name ? "text-accentOrange" : "text-mainBlack"
                    }
                    className={`w-6 h-6 md:w-7 md:h-7 ${iconColor} duration-300 font-bold`}
                  >
                    <path
                ...
                {!isTablet && (
                  <div className={`bottom-0  md:flex md:justify-end w-full`}>
              ...
              <div className="w-full md:w-[55%] flex flex-col justify-center items-center ">
                <textarea
                  className="h-[12rem] md:h-full w-full bg-fontGray p-3 md:p-8  text-mainBlack mb-2 focus:outline-accentOrange mt-10 md:mt-0"
